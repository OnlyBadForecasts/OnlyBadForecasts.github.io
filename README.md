...
For both approaches I want to add in a new feature: day distance from expected peak. The raw data contains a marker showing that the median peak day across years is YYYY-04-10. I think the model would benefit from this as it would add in signal about when in the accumulation/peak/melt phases each observation is and this might work in concert with the cyclical features to improve performance. I will work on this later, but it should be an easy add.
